    ...
    <div ref={menuRef} className="relative">
      <button
        ...
        className={`cursor-pointer rounded-full p-0.5 ring-2 transition-all duration-200 hover:ring-white/30 ${
          isOpen ? "bg-white/10 ring-white/50" : "ring-transparent"
        }`}
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 top-[calc(100%+0.75rem)] w-72 max-w-[calc(100vw-2rem)] overflow-hidden rounded-xl border border-white/10 bg-[#242424]/95 shadow-2xl shadow-black/50 backdrop-blur-md z-50 origin-top-right"
          >

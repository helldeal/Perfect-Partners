...
export const patchNotes: PatchNote[] = [
  ...
  },
  {
    ...
    categories: ["games", "interface", "infrastructure"],
    changes: [
  ...
  },
  {
    ...
    categories: ["infrastructure", "interface"],
    changes: [
  ...
  },
  {
    ...
    categories: ["cinema", "interface", "infrastructure"],
    changes: [
